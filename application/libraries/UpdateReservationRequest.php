...
class UpdateReservationRequest
{
    ...
    public function validate()
    {
        ...
        $this->CI->form_validation->set_rules('id', 'Reservation ID', 'required|integer');


        $this->CI->form_validation->set_rules('hotel_code', 'Hotel Code', 'required');
        $this->CI->form_validation->set_rules('hotel_id', 'Hotel', 'required|integer');
        ...
        $this->CI->form_validation->set_rules(
            'status',
            'Status',
            'required|in_list[active,completed,cancelled]'
        );
