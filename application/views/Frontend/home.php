 ...
 <?php $this->load->view('partial/links');?>
   ...
   <section class="hero-section position-relative text-white">
    <div class="owl-carousel owl-theme" id="heroCarousel">
        ...
        <!-- Slide 1 -->
        <div class="hero-item d-flex align-items-center" style="background: url('<?= base_url('assets_front/images/hero/hero-1.jpg') ?>') center/cover no-repeat;">
            <div class="container">
        ...
        <!-- Slide 2 -->
        <div class="hero-item d-flex align-items-center" style="background: url('<?= base_url('assets_front/images/hero/hero-2.jpg') ?>') center/cover no-repeat;">
            <div class="container">
                <div class="row align-items-center gy-4">
        ...
        <!-- Slide 3 -->
        <div class="hero-item d-flex align-items-center" style="background: url('<?= base_url('assets_front/images/hero/hero-3.jpg') ?>') center/cover no-repeat;">
            <div class="container">
                <div class="row align-items-center gy-4">
